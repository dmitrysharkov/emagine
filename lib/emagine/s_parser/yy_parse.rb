...
[3,2,'_handler9'],
[3,0,'_handler10']]
  @@tokens = {'INTEGER' => "4", 'FLOAT' => "5", 'STRING' => "6", 'SYMBOL' => "7", '\'(\'' => "8", '\')\'' => "9", '$' => "10"}
  ...
  def self._handler1(_x1)
YYParse.__ = _x1
end

def self._handler2(_x1)
YYParse.__ = _x1
end

def self._handler3(_x1)
YYParse.__ = _x1
end

def self._handler4(_x1)
 YYParse.__ = _x1.to_i 
end

def self._handler5(_x1)
 YYParse.__ = _x1.to_f 
end

def self._handler6(_x1)
 YYParse.__ = _x1[1..-2] 
end

def self._handler7(_x1)
 YYParse.__ = _x1.to_sym 
end

def self._handler8(_x1,_x2,_x3)
 YYParse.__ = _x2 
end

def self._handler9(_x1,_x2)
 _x1.push(_x2); YYParse.__ = _x1 
end
...
[/\A-?\d+/, '_lex_rule7'],
[/\A\w+/, '_lex_rule8']]
  @@lex_rules_by_conditions = {'INITIAL' => [0, 1, 2, 3, 4, 5, 6, 7]}
